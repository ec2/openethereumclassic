...
fn rpc_web3_keccak() {
	...
	let request = r#"{"jsonrpc": "2.0", "method": "web3_keccak", "params": ["0x00"], "id": 1}"#;
...
#[test]
fn rpc_web3_keccak_wiki() {
	let web3 = Web3Client::default().to_delegate();
	let mut io = IoHandler::new();
	io.extend_with(web3);

	let request = r#"{"jsonrpc": "2.0", "method": "web3_keccak", "params": ["0x68656c6c6f20776f726c64"], "id": 1}"#;
